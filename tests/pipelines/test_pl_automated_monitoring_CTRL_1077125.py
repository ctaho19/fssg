    ...
    return pd.DataFrame(
        {
            ...
            "monitoring_metric_value": [90.0, 77.78],
            "monitoring_metric_status": [
                "Red",
                "Red",
            ],
            "metric_value_numerator": [9, 7],
            "metric_value_denominator": [10, 9],
            "resources_info": [
                [
                    '{"resourceId": "key1", "accountResourceId": "account1/key1", "keyState": "Enabled", "origin": "N/A (Not Found)"}'
                ],
                [
                    '{"resourceId": "key3", "accountResourceId": "account3/key3", "keyState": "Enabled", "origin": "EXTERNAL"}'
                ],
            ],
...
# Sample KMS Key data with mixed origin values
KMS_KEYS_RESPONSE_DATA = {
    "resourceConfigurations": [
        # 10 total keys, with varying compliance states:
        # - 1 with missing origin (Tier 1 fail)
        # - 2 with wrong origin (Tier 2 fail)
        # - 7 with AWS_KMS origin (fully compliant)
        {
            "resourceId": "key1",
